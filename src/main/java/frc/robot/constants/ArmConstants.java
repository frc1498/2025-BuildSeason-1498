...
public class ArmConstants {
    ...
    public static final double kCoralLoadFloor = -0.15;  //  Load Coral Floor Position - Changing to real measurements, was: 15 degrees - 0.262 radians - 5.254 rotations
    ...
    public static final double kCoralL1 = -0.31; // Level 1 Score Coral Position - Changing to real measurements, was:30 degrees - 0.526 radians - 10.548 rotations
    public static final double kCoralL2 = -0.31; // Level 2 Score Coral Position - Changing to real measurements, was:45 degrees - 0.785 radians - 15.742 rotations
    public static final double kCoralL3 = 0.25; // Level 3 Score Coral Position - Changing to real measurements, was:60 degrees - 1.047 radians - 20.996 rotations
