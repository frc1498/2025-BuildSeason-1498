...
public class WristConstants {
    ...
    public static final double kCoralL1 = 0; // Level 1 Score Coral Position - Changing to real measurements, was:-15 degrees - -0.262 radians - -3.127 rotations
    public static final double kCoralL2 = -0.44; // Level 2 Score Coral Position - Changing to real measurements, was:-20 degrees - -0.349 radians - -4.166 rotations
    public static final double kCoralL3 = 0; // Level 3 Score Coral Position - Changing to real measurements, was:-25 degrees - -0.436 radians - -5.204 rotations
    public static final double kCoralL4 = 0; // Level 4 Score Coral Position - Changing to real measurements, was: 30 degrees - -0.524 radians - -6.255 rotations
    ...
    public static final double kCoralSuck = 30.0;  //  Load Coral Floor Position
