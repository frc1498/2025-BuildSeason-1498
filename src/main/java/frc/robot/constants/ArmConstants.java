...
public class ArmConstants {
    ...
    public static final double kAlgaeL2= -15.742; // Load Algae L2 Position - -45 degrees - -0.785 radians - -15.742 rotations
    public static final double kAlgaeL3 = -20.996; // Load Algae L3 Position - -60 degrees - -1.047 radians - -20.996 rotations
