...
public class ArmConstants {
    ...
    public static final double kCoralL2 = -0.28; // Was -.26 Level 2 Score Coral Position - Changing to real measurements, was:45 degrees - 0.785 radians - 15.742 rotations
    public static final double kCoralL3 = 0.325; // Level 3 Score Coral Position - Changing to real measurements, was:60 degrees - 1.047 radians - 20.996 rotations
    ...
    public static final double kAlgaeL2= -0.350; // Load Algae L2 Position - -45 degrees - Changing to real measurements, was:-0.785 radians - -15.742 rotations
    public static final double kAlgaeL3 = -0.350; // Load Algae L3 Position - -60 degrees - Changing to real measurements, was:-1.047 radians - -20.996 rotations
