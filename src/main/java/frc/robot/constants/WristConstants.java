...
public class WristConstants {
    ...
    public static final double kCoralL4 = 
    -0.425; // Level 4 Score Coral Position - Changing to real measurements, was: 30 degrees - -0.524 radians - -6.255 rotations
    ...
    public static final double kCoralL3Spit = 15.0;  //  L3 spit speed - Decreased from 25
    public static final double kCoralL4Spit = 8.0;  //  L4 spit speed 
    ...
    public static final double kRangeL4SignalStrength = 2500;
