...
public class WristConstants {
    ...
    public static final double kCoralL2 = 0.05; // Was 0.0 Level 2 Score Coral Position - Changing to real measurements, was:-20 degrees - -0.349 radians - -4.166 rotations
    public static final double kCoralL3 = -0.50; // Level 3 Score Coral Position - Changing to real measurements, was:-25 degrees - -0.436 radians - -5.204 rotations
    public static final double kCoralL4 = -0.48; // Level 4 Score Coral Position - Changing to real measurements, was: 30 degrees - -0.524 radians - -6.255 rotations
    ...
    public static final double kCoralL1Spit = 20.0;  //  L1 spit speed 
    public static final double kCoralL2Spit = 25.0;  //  L2 spit speed 
    public static final double kCoralL3Spit = 30;  //  L3 spit speed - Decreased from 25
    ...
    public static final double krangeL3 = 5;
    public static final double kRangeL3SignalStrength = 2500;
    public static final double krangeL4 = 0.3;
    public static final double kRangeL4SignalStrength = 10000;
